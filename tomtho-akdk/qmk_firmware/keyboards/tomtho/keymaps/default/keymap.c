...
const uint16_t PROGMEM screenshot_combo[] = {LT(6,KC_J), KC_K, KC_L, COMBO_END};
const uint16_t PROGMEM paren_combo[] = {LT(6,KC_J), KC_K, COMBO_END};
...
const uint16_t PROGMEM shiftf10_combo[] = {KC_S, KC_D, LT(6,KC_F), COMBO_END};
...
KC_TAB,KC_A,KC_S,KC_D,LT(6,KC_F),KC_G,KC_4,KC_5,KC_6,KC_H,LT(5,KC_J),KC_K,KC_L,KC_MINS,
...
/* layer6 : GUI (右手) */
[6] = LAYOUT(
KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,GUI_7,GUI_8,GUI_9,KC_TRNS,
KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,GUI_4,GUI_5,GUI_6,MC_XL_NOBORDER,
KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,GUI_1,GUI_2,GUI_3,MC_XL_VALIGN,
