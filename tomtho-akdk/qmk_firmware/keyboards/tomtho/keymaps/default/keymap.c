...
KC_TAB,KC_A,KC_S,LT(5,KC_D),KC_F,KC_G,KC_4,KC_5,KC_6,KC_H,LT(5,KC_J),KC_K,KC_L,KC_MINS,
...
[3] = LAYOUT(
KC_TRNS,KC_TRNS,LCTL(KC_W),KC_TRNS,KC_TRNS,LCTL(KC_T),LGUI(KC_7),LGUI(KC_8),LGUI(KC_9),KC_TRNS,MS_WHLU,MS_UP,MS_WHLL,MS_WHLR,
